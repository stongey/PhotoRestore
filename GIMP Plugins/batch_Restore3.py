...
def restore(image, drawable, gammatarg, sat_choice, save):
    ...
    if pdb.gimp_drawable_is_gray(drawable):
        pdb.gimp_message("NewRestore does not work on greyscale images. "
...
def batch_Restore3(directory, gammatarg, sat_choice):
...
register(
  ...
  "The Light-Dark parameter allows some choice about the result. Some pictures are improved by having the "
  "saturation increased but this calculation is VERY slow and hence is optional",
  "Geoff Daniell, gjd@lionhouse.plus.com",
  "Geoff Daniell",
  "2016	",
  "<Toolbox>/Xtns/Batch Restore3", "",
  [
